...
public class TagStrategy<T> : ITagStrategy<T> where T : unmanaged, IEquatable<T>
{
    ...
    public int LtLength => 1;

    public int LtColonLength => 2;

    public int LtSlashLength => 2;

    public int LtSlashColonLength => 3;

    public TagStrategy(Tokens tokens)
    {
        _tokens = tokens;
    }
