...
public static partial class MarkupAlphabets
{
    internal static class CodePage
    {
        ...
        public const int Utf32 = 12000;
        public const int Utf32BE = 12001;
    }
    ...
    internal static class CodePages
    {
        ...
        public static readonly int[] Europa = [CodePage.Europa];
        ...
        public static readonly int[] EBCDIC_Turkish_Latin5 = [CodePage.EBCDIC_Turkish_Latin5];
        public static readonly int[] EBCDIC_Japanese_katakana = [CodePage.EBCDIC_Japanese_katakana];
        public static readonly int[] EBCDIC_Arabic = [CodePage.EBCDIC_Arabic];
        public static readonly int[] EBCDIC_Korean_Extended = [CodePage.EBCDIC_Korean_Extended];
        public static readonly int[] EBCDIC_Thai = [CodePage.EBCDIC_Thai];
        public static readonly int[] EBCDIC_Turkish = [CodePage.EBCDIC_Turkish];

        public static readonly int[] Utf16 = [CodePage.Utf16];
        public static readonly int[] Utf16BE = [CodePage.Utf16BE];
        public static readonly int[] Utf32 = [CodePage.Utf32];
        public static readonly int[] Utf32BE = [CodePage.Utf32BE];
    }
}