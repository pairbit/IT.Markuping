...
public static class MarkupEncodingInfos
{
    ...
    public static bool TryGet(int codePage, [MaybeNullWhen(false)] out MarkupEncodingInfo encodingInfo)
    {
    ...
    public static bool TryGetStrict(int codePage, [MaybeNullWhen(false)] out MarkupEncodingInfo encodingInfo)
    {
