...
{
    public static readonly MarkupEncodingInfo<byte> Utf8_Strict =
    ...
    public static readonly MarkupEncodingInfo<byte> EBCDIC_Strict =
    ...
    public static readonly MarkupEncodingInfo<byte> EBCDIC_Turkish_Strict =
        new(new(1, [76, 110, 97, 122, 64, 252, 126]),
            [1026, 20905]);

    public static readonly MarkupEncodingInfo<byte> Utf8 =
        new(new(1, [(byte)'<', (byte)'>', (byte)'/', (byte)':', (byte)' ', (byte)'"', (byte)'=',
            (byte)'\'', (byte)'\r', (byte)'\n', (byte)'\t']),
    ...
    public static readonly MarkupEncodingInfo<byte> EBCDIC_Turkish =
        new(new(1, [76, 110, 97, 122, 64, 252, 126,
            125, 13, 37, 5]),
            [1026, 20905]);

    public static readonly MarkupEncodingInfo<byte> IBM_Latin1 =
        new(new(1, [76, 110, 97, 122, 64, 127, 126,
            125, 13, 21, 5]),
            [1047, 20924]);

    public static readonly MarkupEncodingInfo<byte> Utf16_Strict =
        new(new(2, [(byte)'<', 0, (byte)'>', 0, (byte)'/', 0, (byte)':', 0, (byte)' ', 0, (byte)'"', 0, (byte)'=', 0]),
            [1200]);

    public static readonly MarkupEncodingInfo<byte> Utf16BE_Strict =
        new(new(2, [0, (byte)'<', 0, (byte)'>', 0, (byte)'/', 0, (byte)':', 0, (byte)' ', 0, (byte)'"', 0, (byte)'=']),
            [1201]);

    public static readonly MarkupEncodingInfo<byte> Utf32_Strict =
        new(new(4, [(byte)'<', 0, 0, 0, (byte)'>', 0, 0, 0, (byte)'/', 0, 0, 0, (byte)':', 0, 0, 0, (byte)' ', 0, 0, 0, (byte)'"', 0, 0, 0, (byte)'=', 0, 0, 0]),
            [12000]);

    public static readonly MarkupEncodingInfo<byte> Utf32BE_Strict =
        new(new(4, [0, 0, 0, (byte)'<', 0, 0, 0, (byte)'>', 0, 0, 0, (byte)'/', 0, 0, 0, (byte)':', 0, 0, 0, (byte)' ', 0, 0, 0, (byte)'"', 0, 0, 0, (byte)'=']),
            [12001]);

    public static readonly MarkupEncodingInfo<byte> Utf16 =
        new(new(2, [(byte)'<', 0, (byte)'>', 0, (byte)'/', 0, (byte)':', 0, (byte)' ', 0, (byte)'"', 0, (byte)'=', 0,
            (byte)'\'', 0, (byte)'\r', 0, (byte)'\n', 0, (byte)'\t', 0]),
            [1200]);

    public static readonly MarkupEncodingInfo<byte> Utf16BE =
        new(new(2, [0, (byte)'<', 0, (byte)'>', 0, (byte)'/', 0, (byte)':', 0, (byte)' ', 0, (byte)'"', 0, (byte)'=',
            0, (byte)'\'', 0, (byte)'\r', 0, (byte)'\n', 0, (byte)'\t']),
            [1201]);

    public static readonly MarkupEncodingInfo<byte> Utf32 =
        new(new(4, [(byte)'<', 0, 0, 0, (byte)'>', 0, 0, 0, (byte)'/', 0, 0, 0, (byte)':', 0, 0, 0, (byte)' ', 0, 0, 0, (byte)'"', 0, 0, 0, (byte)'=', 0, 0, 0,
            (byte)'\'', 0, 0, 0, (byte)'\r', 0, 0, 0, (byte)'\n', 0, 0, 0, (byte)'\t', 0, 0, 0]),
            [12000]);

    public static readonly MarkupEncodingInfo<byte> Utf32BE =
        new(new(4, [0, 0, 0, (byte)'<', 0, 0, 0, (byte)'>', 0, 0, 0, (byte)'/', 0, 0, 0, (byte)':', 0, 0, 0, (byte)' ', 0, 0, 0, (byte)'"', 0, 0, 0, (byte)'=',
            0, 0, 0, (byte)'\'', 0, 0, 0, (byte)'\r', 0, 0, 0, (byte)'\n', 0, 0, 0, (byte)'\t']),
            [12001]);

    public static bool TryGet(int codePage, [MaybeNullWhen(false)] out MarkupEncodingInfo<byte> encodingInfo)
    {
    ...
    public static bool TryGetStrict(int codePage, [MaybeNullWhen(false)] out MarkupEncodingInfo<byte> encodingInfo)
    {
